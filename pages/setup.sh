...
-d '{"type":"stream.online","version":"1","condition":{"broadcaster_user_id":"56931496"},"transport":{"method":"webhook","callback":"https://robocop.bashsta.cc/webhook","secret":"'${TWITCH_EVENTSUB_SECRET}'"}}')
